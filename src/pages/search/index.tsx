    ...
    return (
        <div className="flex flex-col">
            <div className="fixed left-0 top-0 bg-blue-300 h-36 w-screen z-10">
                <img src="/images/googlelogo_color.png" alt="google" className="w-52 ml-20 top-10 absolute"></img>
                <SearchBar className={"absolute w-48 left-52 top-14 ml-28"} func={search} showButtons={false}></SearchBar>
            </div>
